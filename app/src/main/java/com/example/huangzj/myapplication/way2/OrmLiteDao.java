...
public class OrmLiteDao<T> {
    ...
    public boolean deleteById(int id) {
        ...
        if (result > 0) {
            ...
            LogUtil.w("delete error,delete line:" + result);
        }
        return true;
    }
    ...
    public boolean deleteByColumnName(String columnName, Object value) {
        ...
        if (result > 0) {
            ...
            LogUtil.w("delete error, columnName: " + columnName + ", value: " + value + ", result: " + result);
        }
        return true;
    }
    ...
    public boolean deleteForBatch(List<T> list) {
        ...
        if (result) {
            ...
            LogUtil.w("deleteForBatch error,result:" + result);
        }
        return result;
    }
    ...
    public boolean update(T t) {
        ...
        if (result > 0) {
            ...
            LogUtil.w("update error,update line:" + result);
        }
        return result > 0;
    }
    ...
    private void setObjectValueIfNotNull(T t, Object obj) throws IllegalAccessException, NoSuchFieldException, InstantiationException {
        ...
        for (Field field : fields) {
            ...
            if (valueObj != null) {
                ...
                LogUtil.w(field.getName() + " is null.");
            }
        }
    }
