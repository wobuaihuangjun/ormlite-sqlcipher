...
public class ApiCompatibilityUtils {
	...
	static {
		if (Build.VERSION.SDK_INT >= JELLY_BEAN) {
			compatibility = new com.j256.ormlite.sqlcipher.android.compat.JellyBeanApiCompatibility();
		} else {
			compatibility = new com.j256.ormlite.sqlcipher.android.compat.BasicApiCompatibility();
		}
	}
